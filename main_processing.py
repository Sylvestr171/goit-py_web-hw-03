...
def factorize_without_multiproc(*number) -> list:

    logging.info("Функція factorize")
...
def factorize_with_multiproc(*number) -> list:
...
if __name__ == '__main__':
    ...
    a, b, c, d, e, f, g, h= factorize_without_multiproc(128, 255, 99999, 10651060, 100000007, 100000037, 100000039, 1000000007)
    end_without_multiproc = time.perf_counter()
    elapsed_without_multiproc = end_without_multiproc - start_without_multiproc
    print(colorama.Fore.RED, "Час виконання factorize_without_multiproc ", elapsed_without_multiproc, colorama.Fore.RESET)
    ...
    a2, b2, c2, d2, e2, f2, g2, h2 = factorize_with_multiproc(1000000007, 100000039, 128, 255, 99999, 10651060, 100000007, 100000037)
    end = time.perf_counter()
    elapsed = end - start
    print(colorama.Fore.RED, "Час виконання factorize_with_multiproc ", elapsed, colorama.Fore.RESET)
    ...
    assert f2 == [1, 2, 4, 5, 7, 10, 14, 20, 28, 35, 70, 140, 76079, 152158, 304316, 380395, 532553, 760790, 1065106, 1521580, 2130212, 2662765, 5325530, 10651060]
